...
class Board:
    ...
    def _get_grid_cordinates(self):
        ...
        for i in range(0, 7):
            for j in range(0, 6):
                x = startCord[0] + i * 2.85
                y = startCord[1] + j * 1.15
    ...
    def _capture_image(self):
       ...
       # im1 = image.open(r"C:\Users\20112\pythonProject25")
    ...
    def _get_grid(self):
       ...
       # cropedImage.show()
        #im1 = cropedImage.open(r"C:\Users\20112\pythonProject25\flower1.jpg")
       # im1.save("flower1.jpg")
